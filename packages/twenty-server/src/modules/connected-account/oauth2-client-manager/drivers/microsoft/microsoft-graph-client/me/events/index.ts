...
// @ts-ignore
import { createEventCollectionResponseFromDiscriminatorValue, createEventFromDiscriminatorValue, serializeEvent, type Event, type EventCollectionResponse } from '../../models/index.js';
// @ts-ignore
 ...
 */
export const EventsRequestBuilderUriTemplate = "{+baseurl}/me/events{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**

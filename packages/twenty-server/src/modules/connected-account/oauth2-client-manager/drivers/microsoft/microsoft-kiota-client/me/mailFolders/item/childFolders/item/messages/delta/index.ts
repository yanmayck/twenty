...
// @ts-ignore
import { createMessageFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeMessage, type BaseDeltaFunctionResponse, type Message } from '../../../../../../../models/index.js';
// @ts-ignore
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top,changeType*}";
/**

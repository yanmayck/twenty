...
// @ts-ignore
import { createMailFolderFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeMailFolder, type BaseDeltaFunctionResponse, type MailFolder } from '../../../../../models/index.js';
// @ts-ignore
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**

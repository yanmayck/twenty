//TODO : Refacto common - remove this comment - This parser is a copy of the OrderByInputFactory without objectMetadata dependecy. Validation will be done in common layer
...
@Injectable()
export class OrderByRequestParser {
  parse(request: Request): ObjectRecordOrderBy {
